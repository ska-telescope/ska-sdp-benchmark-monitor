...
# Parameters
APP=/usr/bin/hostname # $HOME/BENCHMARKS/NAS/NPB3.4.2/NPB3.4-MPI/bin_openmpi-4.1.4_gcc-10.4.0/lu.A.x
...
mpirun -host $HOSTS ./benchmonspc.sh --sys --pow --sudo-perf-cmd sudo-g5k --traces-repo ./my_repo &
