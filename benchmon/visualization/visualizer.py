...
class BenchmonVisualizer:
    ...
    def run_plots(self) -> None:
        ...
        try:
            ...
            # Only label the first plot as stage box labels are a bit messy
            first_plot = True
            # CPU plot
            if self.args.cpu:
                if self.system_metrics:
                    ...
                    if self.stage_boxes:
                        plot_stage_boxes(self.stage_boxes, first_plot)
                        first_plot = False
                else:
            ...
            if self.args.cpu_freq:
                if self.system_metrics:
                    ...
                    if self.stage_boxes:
                        plot_stage_boxes(self.stage_boxes, first_plot, ymax=freqmax)
                        first_plot = False
                else:
            ...
            if self.args.mem:
                if self.system_metrics:
                    ...
                    if self.stage_boxes:
                        plot_stage_boxes(self.stage_boxes, first_plot, ymax=memmax)
                        first_plot = False
                else:
            ...
            if self.args.net or self.args.net_all or self.args.net_data:
                if self.system_metrics:
                    ...
                    if self.stage_boxes:
                        plot_stage_boxes(self.stage_boxes, first_plot, ymax=netmax)
                        first_plot = False
                else:
            ...
            if self.args.ib:
                if self.system_metrics:
                    ...
                    if self.stage_boxes:
                        plot_stage_boxes(self.stage_boxes, first_plot, ymax=ibmax)
                        first_plot = False
                else:
            ...
            if self.args.disk:
                if self.system_metrics:
                    ...
                    if self.stage_boxes:
                        plot_stage_boxes(self.stage_boxes, first_plot, ymax=diskmax)
                        first_plot = False
                else:
            ...
            if self.args.pow or self.args.pow_g5k:
                ...
                if self.stage_boxes:
                    plot_stage_boxes(self.stage_boxes, first_plot, ymax=powmax)
                    first_plot = False
