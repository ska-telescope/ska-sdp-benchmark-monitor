...
DATA = {
    "variable": [
        {
            "hostname": HOSTNAME,
            "time": ts(0),
            "stamp": int(ts(0).timestamp() * 1e9),
        },
        {
            "hostname": HOSTNAME_2,
            "time": ts(3600),
            "stamp": int(ts(3600).timestamp() * 1e9),
        },
    ],
    "cpu_total": [
        {
    ...
    "infiniband": [
        ...
        },
        {
            ...
            "device": "mlx5_0",
            "time": ts(60),
            "port_rcv_data": 15_000_000,
            "port_xmit_data": 20_000_000,
        },
        {
            "hostname": HOSTNAME,
            "device": "mlx5_0",
            "time": ts(120),
            "port_rcv_data": 30_000_000,
            "port_xmit_data": 35_000_000,
        },
    ],
}
